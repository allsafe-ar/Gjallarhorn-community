...
## Visión
Plataforma SOC de código abierto con análisis de IOC, malware y forense de email, integración real con herramientas SOC (TheHive, Wazuh, Velociraptor, OpenVAS, Nessus) y correlación automática entre fuentes. Seguridad enterprise (JWT + 2FA + RBAC + audit) con orquestación SOC como identidad propia de Gjallar.
...
├── Investigación IOC      ← 20+ fuentes threat intel paralelas
├── Análisis de Archivos   ← malware, PE, scripts, beacons
├── Forense de Email       ← .eml phishing/BEC detection
...
La integración real con herramientas SOC es la identidad diferencial de Gjallar.
...
- Scoring: sistema de pesos por fuente implementado en JS nativo
